...
window.BIOKDD_YEARS = [
  {y:2001, n:'1st',  loc:'San Francisco, CA',          theme:'Founding — open call on biological data mining',                  phase:1, url:'https://biokdd.org/biokdd01/'},
  {y:2002, n:'2nd',  loc:'Edmonton, Canada',           theme:'Recent advances in biological data mining',                       phase:1, url:'https://biokdd.org/biokdd02/'},
  {y:2003, n:'3rd',  loc:'Washington, DC',             theme:'Open call · sequence & expression',                               phase:1, url:'https://biokdd.org/biokdd03/'},
  {y:2004, n:'4th',  loc:'Seattle, WA',                theme:'Bioinformatics, genomics, neuroscience',                          phase:1, url:'https://biokdd.org/biokdd04/'},
  {y:2005, n:'5th',  loc:'Chicago, IL',                theme:'Open call · sequence, structure, expression',                     phase:1, url:'https://biokdd.org/biokdd05/'},
  {y:2006, n:'6th',  loc:'Philadelphia, PA',           theme:'Open call · functional & comparative genomics',                   phase:1, url:'https://biokdd.org/biokdd06/'},
  ...
  {y:2012, n:'11th', loc:'Beijing, China',             theme:'Open call · post-genomic data mining',                            phase:2, url:'https://biokdd.org/biokdd12/'},
  {y:2013, n:'12th', loc:'Chicago, IL',                theme:'Building network and predictive models',                          phase:2, url:'https://biokdd.org/biokdd13/'},
  {y:2014, n:'13th', loc:'New York City',              theme:'Knowledge discovery using big data in biomedical systems',        phase:2, url:'https://biokdd.org/biokdd14/'},
  {y:2015, n:'14th', loc:'Sydney, Australia',          theme:'Knowledge discovery on complex biological & medical data',        phase:3, url:'https://biokdd.org/biokdd15/'},
  {y:2016, n:'15th', loc:'San Francisco, CA',          theme:'Complex biological & medical data, continued',                    phase:3, url:'https://biokdd.org/biokdd16/'},
